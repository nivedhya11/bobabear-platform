...
const COPY: Readonly<Record<string, string>> = Object.freeze({
  ...
  CUSTOMER_ADDRESS_PERSISTENCE_ERROR:
    "We couldn't update that address. Try again shortly.",
  CUSTOMER_ADDRESS_AUDIT_ERROR:
    "We couldn't update that address. Try again shortly.",
  CUSTOMER_ADDRESS_RECIPIENT_NAME_INVALID: "Enter a valid recipient name.",
  CUSTOMER_ADDRESS_RECIPIENT_PHONE_INVALID: "Enter a valid 10-digit mobile number.",
  CUSTOMER_ADDRESS_LINE1_REQUIRED: "Address line 1 is required.",
  CUSTOMER_ADDRESS_LINE1_INVALID: "Enter a valid address line.",
  CUSTOMER_ADDRESS_LINE2_INVALID: "Enter a valid floor, block, or unit.",
  CUSTOMER_ADDRESS_LANDMARK_INVALID: "Enter a valid landmark.",
  CUSTOMER_ADDRESS_LOCALITY_INVALID: "Enter a valid locality.",
  CUSTOMER_ADDRESS_LABEL_INVALID: "Enter a valid address label.",
  CUSTOMER_ADDRESS_COORDINATES_INVALID: "Confirm the pin on the map and try again.",
