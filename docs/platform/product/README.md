...
Architecture Fit = NOT_PERFORMED — Fit candidate at
[`../capabilities/IMP-036H-customer-pickup-takeaway.md`](../capabilities/IMP-036H-customer-pickup-takeaway.md)
(`CANDIDATE_READY_FOR_INDEPENDENT_REVIEW`; D-378 / ADR-018 PROPOSED; ARCH-R22 not CURRENT);
Architecture = NOT_LOCKED; **IMP036H_ACTIVATED: YES**;
CURRENT `currentProductSlice` under `PROGRAM_PAUSE: PRE_GTM_PRODUCT_INSERTION_PROVIDER_BLOCKED`
(**D-377**); Implementation = NOT_AUTHORIZED / NOT_STARTED; `IMP036H_ACCEPTED: NO`).
