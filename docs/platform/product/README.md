...
| [IMP-036H Product Definition](./IMP-036H/product-definition.md) | `PD-IMP-036H-DRAFT-1`; **APPROVED**; Product Definition Gate = **PASS**; Architecture Fit = **PASS**; Architecture = **LOCKED** ([`../capabilities/IMP-036H-customer-pickup-takeaway.md`](../capabilities/IMP-036H-customer-pickup-takeaway.md); D-378 / ADR-018 **CURRENT**; ARCH-R22 / ARCH-G28); Implementation = **AUTHORIZED** / **STARTED** / **COMPLETE**; formal lifecycle = `IMPLEMENTATION_COMPLETE_PENDING_ACCEPTANCE`; **IMP036H_ACTIVATED: YES**; CURRENT `currentProductSlice` = IMP-036H; `pendingAcceptance` = IMP-036H; `nextProductSlice` = IMP-036I; under `PROGRAM_PAUSE: PRE_GTM_PRODUCT_INSERTION_PROVIDER_BLOCKED` (**D-377**) (ROADMAP/STATE remain lifecycle authority; `acceptedThrough` = IMP-036G; `IMP036H_IMPLEMENTATION_COMPLETE: YES`; `IMP036H_ACCEPTED: NO`; `IMP036H_FOUNDER_UAT: NOT_PERFORMED`; evidence [`./IMP-036H/evidence-candidate.md`](./IMP-036H/evidence-candidate.md)) |
...
**IMP036H_ACTIVATED: YES**; CURRENT `currentProductSlice` under
`PROGRAM_PAUSE: PRE_GTM_PRODUCT_INSERTION_PROVIDER_BLOCKED` (**D-377**); `IMP036H_ACCEPTED: NO`).
