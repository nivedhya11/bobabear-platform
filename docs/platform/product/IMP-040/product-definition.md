...
treat this draft as lifecycle authority): `GTM-R148` / `STATE-R146` —
`acceptedThrough = IMP-036H`; `currentProductSlice = IMP-036I` under
`PROGRAM_PAUSE: PRE_GTM_PRODUCT_INSERTION_PROVIDER_BLOCKED` (**D-377**)
(`IMP036I_ACTIVATED: YES`; formal IMP-036I lifecycle PLANNED; PD `PRE_GATE_DRAFT`;
Gate NOT_PERFORMED; Fit NOT_PERFORMED; implementation NOT_AUTHORIZED);
IMP-036H remains `COMPLETE_AND_ACCEPTED`; IMP-037/038 remain held (`IMP037_HOLD` / `IMP038_HOLD`);
...
relative to CURRENT GTM-R148 / STATE-R146.
...
| Canonical anchors | VISION-1; ROADMAP GTM-R132; STATE STATE-R130 (historical draft-time anchors; CURRENT tip is GTM-R148 / STATE-R146 — see lifecycle note above); ARCH-R20 / DR-16 CURRENT (draft originally cited ARCH-R19 / DR-15); PD-1; TEST-1; PERSONA-1; GJ-1 |
...
(`acceptedThrough` IMP-036H; `nextProductSlice` IMP-037; tip GTM-R148 / STATE-R146).
