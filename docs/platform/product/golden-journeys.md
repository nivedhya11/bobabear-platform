...
| `GJ-AVAILABILITY` / `JOURNEY-AVAILABILITY` — Availability change reaches the customer | `PERSONA-WORKFORCE-OPERATOR`, `PERSONA-CUSTOMER` | `PARTIAL` | Permitted Variant/Modifier availability change → customer sees authoritative availability and orderability on a fresh read/evaluation. IMP-036C customer presentation is accepted; IMP-036E Store workspace remains pending acceptance. This row promises no push update, stock reservation, or new timing guarantee. | [IMP-036E §5](../capabilities/IMP-036E-store-operations-management.md); [IMP-036C §§2, 4](../capabilities/IMP-036C-customer-commerce-experience-v2.md). |
| `GJ-PRODUCT-MENU-LAUNCH` / `JOURNEY-PRODUCT-MENU-LAUNCH` — Product/menu launch | `PERSONA-WORKFORCE-OPERATOR`, `PERSONA-CUSTOMER` | `PLANNED` | Intended continuity: authorized commercial configuration → appropriate Menu organization and outlet context → customer discovery/orderability. IMP-036F must define the actual acceptance slice; no new publish lifecycle, media-upload support, monetary policy, or bulk semantics is inferred. | [Planned IMP-036F contract](../experience/enterprise-experience/IMP-036F-catalog-menu-pricing-promotions.md); [ROADMAP](../ROADMAP.md). IMP-036F remains PLANNED / NOT_ACTIVATED / NOT_AUTHORIZED / NOT_STARTED. |
| `GJ-STORE-PAUSE-RESUME` / `JOURNEY-STORE-PAUSE-RESUME` — Store pause/resume | `PERSONA-WORKFORCE-OPERATOR`, `PERSONA-CUSTOMER` | `PARTIAL` | Permitted operator pauses/resumes an Outlet → operational eligibility is reflected in subsequent serviceability/order evaluation. Resume does not override schedule or suspension rules. IMP-036E UI requires its outstanding Founder UAT and acceptance. | [IMP-036E §6](../capabilities/IMP-036E-store-operations-management.md); [IMP-036B §4.1](../capabilities/IMP-036B-customer-account-onboarding-address-location.md). |
...
| `GJ-TRADING-HOURS` / `JOURNEY-TRADING-HOURS` — Trading-hours change | `PERSONA-WORKFORCE-OPERATOR`, `PERSONA-CUSTOMER` | `PARTIAL` | Authorized valid schedule replacement → effective operating state → subsequent customer eligibility evaluation. Include closed-day/overnight context using existing schedule semantics; no new schedule state is implied. IMP-036E workspace acceptance remains outstanding. | [IMP-036E §§6–7](../capabilities/IMP-036E-store-operations-management.md); [IMP-036B §4.1](../capabilities/IMP-036B-customer-account-onboarding-address-location.md). |
| `GJ-ADDRESS-SERVICEABILITY` / `JOURNEY-ADDRESS-SERVICEABILITY` — Address/serviceability change | `PERSONA-CUSTOMER`, `PERSONA-WORKFORCE-OPERATOR` | `PARTIAL` | Customer address/location change → coordinate-based serviceability → Checkout re-evaluation is accepted in IMP-036B/C. Store distance-policy editing extends this continuity through IMP-036E, which is unaccepted. Postal/PIN metadata, a map, and provider cost never determine geographic eligibility or payable truth. | [IMP-036B §§1, 4.1–5](../capabilities/IMP-036B-customer-account-onboarding-address-location.md); [IMP-036C §§2–4](../capabilities/IMP-036C-customer-commerce-experience-v2.md); [IMP-036E §8](../capabilities/IMP-036E-store-operations-management.md). |
