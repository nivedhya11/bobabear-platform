...
Lifecycle truth remains ROADMAP/STATE only (CURRENT tip: `GTM-R151` / `STATE-R149` IMP-036I Product Definition DRAFT_READY_FOR_GATE; `currentProductSlice = IMP-036I`; `IMP036I_ACTIVATED: YES`; prior tip `GTM-R149` / `STATE-R147` IMP-036I Product Definition DRAFT_READY; prior tip `GTM-R148` / `STATE-R146` IMP-036I Product Definition activation; prior tip `GTM-R147` / `STATE-R145` IMP-036H COMPLETE_AND_ACCEPTED; prior tip `GTM-R146` / `STATE-R144` IMP-036H
