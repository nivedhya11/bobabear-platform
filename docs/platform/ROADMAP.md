...
(`PD-IMP-038-DRAFT-1`); `IMP038_PRODUCT_DEFINITION_GATE: NOT_PERFORMED`;
...
Product Definition `PD-IMP-038-DRAFT-1` DRAFT / PRE-GATE; Gate NOT_PERFORMED;
...
- Sets `IMP038_ACTIVATED: YES`; formal IMP-038 lifecycle `PLANNED`; Product Definition
  `PD-IMP-038-DRAFT-1` DRAFT / PRE-GATE; Gate NOT_PERFORMED; Architecture Fit NOT_PERFORMED;
