...
Current Governance Activity:    IMP-036H Implementation AUTHORIZED / NOT_STARTED
                              (GTM-R144 / STATE-R142;
                              PROGRAM_PAUSE: PRE_GTM_PRODUCT_INSERTION_PROVIDER_BLOCKED;
                              PROGRAM_PAUSE_AUTHORITY: D-377;
                              IMP036H_ACTIVATED: YES; formal lifecycle ARCHITECTURE_LOCKED;
...
Active Product Definition (IMP-036H; APPROVED; Gate PASS; Fit PASS; architecture LOCKED; implementation NOT_AUTHORIZED / NOT_STARTED):
...
- IMP-036H — Customer Pickup / Takeaway (`ARCHITECTURE_LOCKED`; `IMP036H_ACTIVATED: YES`; Product Definition `APPROVED` / `PD-IMP-036H-DRAFT-1`; Gate `PASS`; Architecture Fit `PASS`; architecture `LOCKED`; implementation `AUTHORIZED` / `NOT_STARTED`; `IMP036H_IMPLEMENTATION_AUTHORIZED: YES`; `IMP036H_STARTED: NO`; `IMP036H_ACCEPTED: NO`; `IMP036H_FOUNDER_UAT_REQUIRED: YES`; CURRENT `currentProductSlice` under `PROGRAM_PAUSE: PRE_GTM_PRODUCT_INSERTION_PROVIDER_BLOCKED` / **D-377**)
...
| IMP-036H Product Definition (APPROVED; Gate PASS; Fit PASS; LOCKED; AUTHORIZED / NOT_STARTED) | [`product/IMP-036H/product-definition.md`](./product/IMP-036H/product-definition.md) |
