...
Current Governance Activity:    IMP-036G activated as CURRENT product slice (GTM-R123 / STATE-R121);
                              ...
                              IMP036G_ACTIVATED: YES; IMP036G_PRODUCT_DEFINITION: NOT_CREATED;
                              ...
                              PD-1 next phase ANCHOR → DISCOVER; no Product Definition Gate,
                              architecture lock, implementation authorization, implementation
                              start, acceptance, or IMP-037 activation has occurred;
...
- IMP-036G — Administration Console V2 (`PLANNED` / `NOT_AUTHORIZED` / `NOT_STARTED`; `IMP036G_ACTIVATED: YES`; Product Definition NOT_CREATED; architecture NOT_LOCKED; implementation NOT_AUTHORIZED / NOT_STARTED)
...
## 19. STATE-R112 record (historical compression)
