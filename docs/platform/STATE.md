...
Current Governance Activity:    IMP-036G Product Definition Gate PASS;
                              PD-IMP-036G-DRAFT-2 APPROVED;
                              Architecture Fit NOT_PERFORMED
                              (GTM-R126 / STATE-R124);
                              gate-evaluated head
                              1fe1737d8f05d6069b2073d9faf1142d21b91970 /
                              tree 25412cbadf224ef709687fe067f2427784a414cc;
                              ...
                              Architecture Fit, architecture lock, implementation authorization,
                              implementation start, acceptance, and IMP-037 activation have NOT
                              occurred;
...
- IMP-036G — Administration Console V2 (`PLANNED` / `NOT_AUTHORIZED` / `NOT_STARTED`; `IMP036G_ACTIVATED: YES`; Product Definition APPROVED `PD-IMP-036G-DRAFT-2`; Founder product decisions RESOLVED (7/7); Product Definition Gate PASS; Architecture Fit NOT_PERFORMED; architecture NOT_LOCKED; implementation NOT_AUTHORIZED / NOT_STARTED)
...
## 22. STATE-R112 record (historical compression)
