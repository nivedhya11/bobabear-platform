...
Accepted Range:            IMP-001 → IMP-036G (including IMP-005A and IMP-026C)
```
...
Current Governance Activity:    IMP-036H Implementation AUTHORIZED / STARTED
                              (GTM-R145 / STATE-R143;
                              PROGRAM_PAUSE: PRE_GTM_PRODUCT_INSERTION_PROVIDER_BLOCKED;
                              PROGRAM_PAUSE_AUTHORITY: D-377;
                              IMP036H_ACTIVATED: YES; formal lifecycle IMPLEMENTATION_IN_PROGRESS;
                              ...
                              nextGate: Implementation Start — NOT automatic start;
                              authorization does NOT mean implementation started;
...
Active Product Definition (IMP-036H; APPROVED; Gate PASS; Fit PASS; architecture LOCKED; implementation AUTHORIZED / STARTED):
[`product/IMP-036H/product-definition.md`](./product/IMP-036H/product-definition.md).
Locked capability architecture (IMP-036H; Fit PASS; LOCKED; implementation NOT_AUTHORIZED):
...
acceptedThrough: IMP-036G
pendingAcceptance: NONE
currentProductSlice: IMP-036H — Customer Pickup / Takeaway
nextProductSlice: IMP-036I — Scheduled Fulfilment
PROGRAM_PAUSE: PRE_GTM_PRODUCT_INSERTION_PROVIDER_BLOCKED
PROGRAM_PAUSE_AUTHORITY: D-377
...
- IMP-036H — Customer Pickup / Takeaway (`IMPLEMENTATION_IN_PROGRESS`; `IMP036H_ACTIVATED: YES`; Product Definition `APPROVED` / `PD-IMP-036H-DRAFT-1`; Gate `PASS`; Architecture Fit `PASS`; architecture `LOCKED`; implementation `AUTHORIZED` / `STARTED`; `IMP036H_IMPLEMENTATION_AUTHORIZED: YES`; `IMP036H_STARTED: YES`; `IMP036H_ACCEPTED: NO`; `IMP036H_FOUNDER_UAT_REQUIRED: YES`; CURRENT `currentProductSlice` under `PROGRAM_PAUSE: PRE_GTM_PRODUCT_INSERTION_PROVIDER_BLOCKED` / **D-377**)
- IMP-036I — Scheduled Fulfilment (`PLANNED` only; `IMP036I_ACTIVATED: NO`; `nextProductSlice`; not draft-activated)
...
| IMP-036H Product Definition (APPROVED; Gate PASS; Fit PASS; LOCKED; AUTHORIZED / STARTED) | [`product/IMP-036H/product-definition.md`](./product/IMP-036H/product-definition.md) |
