...
```text
VISION = VISION-1
ROADMAP = GTM-R142 (CURRENT tip — IMP-036H Product Definition Gate PASS under PROGRAM_PAUSE D-377; verify CURRENT at read time)
STATE = STATE-R140 (CURRENT tip — program pause; verify CURRENT at read time)
...
LEGAL_REVIEW_OPEN_TOPICS: 9
COMPLIANCE_CLAIMS: NONE
CANONICAL_TIP: GTM-R142 / STATE-R140 / ARCH-R21 / DR-19
PRIOR_AUTHORIZE_START_TIP: GTM-R140 / STATE-R138
PRIOR_LOCK_TIP: GTM-R139 / STATE-R137
IMP038_IMPLEMENTATION_COMPLETE: YES
IMP038_HOLD: YES
