...
PRIOR_TIP = GTM-R141 / STATE-R139 (IMP-036H Product Definition activation)
```

`CANONICAL_ROADMAP_STATE = GTM-R144 / STATE-R142` is the **CURRENT tip** (IMP-036H Implementation AUTHORIZED / NOT_STARTED under PROGRAM_PAUSE D-377; prior tip GTM-R143 / STATE-R141 Architecture Fit PASS + architecture lock; prior tip GTM-R142 / STATE-R140 IMP-036H Product
Definition Gate PASS under `PROGRAM_PAUSE` D-377; IMP-038 held with
...
```text
VISION = VISION-1
ROADMAP = GTM-R144 (CURRENT tip — IMP-036H Implementation AUTHORIZED / NOT_STARTED under PROGRAM_PAUSE D-377; verify CURRENT at read time)
STATE = STATE-R142 (CURRENT tip — program pause; verify CURRENT at read time)
PRIOR_ARCHITECTURE_LOCK_TIP = GTM-R143 / STATE-R141
...
Implementation tranches A–F are complete (`IMP038_IMPLEMENTATION_COMPLETE: YES`). The following remain **not** done:

- PROVE complete / independent technical acceptance  
- Cloudflare / DO firewall / AOP production provisioning (IMP-039)  
- Founder UAT  
- IMP-038 formal acceptance (`IMP038_ACCEPTED: NO`)  
- IMP-039 activation  
- Any DPDP / CERT-In / PCI / ASVS compliance claim  
- Independent external web/API security assessment (`GAP-EXT-ASSESS-001: NOT_CLOSED`)  
- Closure of `GAP-IMP037-001` (OPEN)
...
LEGAL_REVIEW_OPEN_TOPICS: 9
COMPLIANCE_CLAIMS: NONE
CANONICAL_TIP: GTM-R144 / STATE-R142 / ARCH-R22 / DR-20
PRIOR_AUTHORIZE_START_TIP: GTM-R140 / STATE-R138
PRIOR_LOCK_TIP: GTM-R139 / STATE-R137
IMP038_IMPLEMENTATION_COMPLETE: YES
IMP038_HOLD: YES
