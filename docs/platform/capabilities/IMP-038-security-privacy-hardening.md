...
`CANONICAL_ROADMAP_STATE = GTM-R143 / STATE-R141` is the **CURRENT tip** (IMP-036H Architecture Fit
PASS + architecture lock under PROGRAM_PAUSE D-377; prior tip GTM-R142 / STATE-R140 IMP-036H Product
...
```text
VISION = VISION-1
ROADMAP = GTM-R143 (CURRENT tip — IMP-036H Architecture Fit PASS + architecture lock under PROGRAM_PAUSE D-377; verify CURRENT at read time)
STATE = STATE-R141 (CURRENT tip — program pause; verify CURRENT at read time)
...
LEGAL_REVIEW_OPEN_TOPICS: 9
COMPLIANCE_CLAIMS: NONE
CANONICAL_TIP: GTM-R143 / STATE-R141 / ARCH-R22 / DR-20
PRIOR_AUTHORIZE_START_TIP: GTM-R140 / STATE-R138
PRIOR_LOCK_TIP: GTM-R139 / STATE-R137
IMP038_IMPLEMENTATION_COMPLETE: YES
IMP038_HOLD: YES
