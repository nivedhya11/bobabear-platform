...
| GAP-EXT-ASSESS-001 | GAP | Independent external web/API security assessment + Critical/High retest | Founder-commissioned assessor | YES before IMP-038 acceptance | FD-038-18; briefing pinned at [`external-assessment-briefing.md`](./external-assessment-briefing.md); `INDEPENDENT_EXTERNAL_ASSESSMENT: NOT_PERFORMED` |
