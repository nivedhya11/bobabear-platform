...
|---|---|---|---|---|---|
| GAP-CSP-ENFORCE-001 | CLOSED | CSP Enforce active on serving path after D-376 Maps Fonts inventory amendment; Maps/menu Enforce journeys PASS; AC-001-03 evil script blocked under Enforce; remaining OTP/Turnstile/Razorpay/workforce journeys PARTIAL/BLOCKED on staging provider/session limits (not inventory) | Platform ops | YES for final V1 CSP AC | 2026-09-23 evidence: [`csp-header-evidence.md`](./csp-header-evidence.md); D-376 / DR-18 |
...
| GAP-EXT-ASSESS-001 | GAP | Independent external web/API security assessment + Critical/High retest | Founder-commissioned assessor | YES before IMP-038 acceptance | FD-038-18; briefing pinned at [`external-assessment-briefing.md`](./external-assessment-briefing.md) (`ASSESSMENT_HEAD=dc6b19e6…`); identity readiness [`assessor-identity-readiness.md`](./assessor-identity-readiness.md); `ASSESSMENT_WINDOW_STARTED=YES`; `FINAL_ASSESSMENT_CANDIDATE: FROZEN`; `INDEPENDENT_EXTERNAL_ASSESSMENT: NOT_PERFORMED` |
