...
`IMP036H_ACCEPTED: YES`; `IMP036H_FOUNDER_UAT: PASS`; `IMP036H_FORMAL_ACCEPTANCE: ACCEPTED` at tip
GTM-R147 / STATE-R145; `acceptedThrough` = IMP-036H; `currentProductSlice` = NONE;
`pendingAcceptance` = NONE; `nextProductSlice` = IMP-036I; `IMP036I_ACTIVATED: NO`). IMP-038 remains held (`IMP038_HOLD: YES`;
