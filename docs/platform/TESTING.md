...
(`IMP036F_ACTIVATED` / `IMP036G_ACTIVATED`). IMP-036G is `COMPLETE_AND_ACCEPTED`
(`IMP036G_ACCEPTED: YES`; Founder UAT PASS); `currentProductSlice = NONE`. IMP-037 remains
unactivated. TEST-1 remains the verification policy
