...
- New decisions continue after the highest CURRENT/AMENDED/PROPOSED register ID: next ID **D-380**
  (**D-379** is reserved as **PROPOSED** for IMP-036I Scheduled Fulfilment Timing + Future Execution
  Boundary; not CURRENT until Architecture Fit lock persistence).
