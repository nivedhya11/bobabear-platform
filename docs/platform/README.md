...
| [`capabilities/IMP-036E-store-operations-management.md`](./capabilities/IMP-036E-store-operations-management.md) | CURRENT / ARCHITECTURE_LOCKED | IMP-036E Store Operations Management; architecture LOCKED; IMPLEMENTATION_IN_PROGRESS; AUTHORIZED / STARTED (`IMP-036E_ARCHITECTURE_LOCKED: YES`; Founder UAT required) |
