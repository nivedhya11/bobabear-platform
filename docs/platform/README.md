...
| [`capabilities/IMP-036I-scheduled-fulfilment.md`](./capabilities/IMP-036I-scheduled-fulfilment.md) | CURRENT / ARCHITECTURE_LOCKED / Fit PASS | IMP-036I Scheduled Fulfilment; D-379 / ADR-019 **CURRENT** / **Accepted**; D-380 / ADR-020 **CURRENT** / **Accepted**; ARCH-R23 / ARCH-G29 + ARCH-G30; Architecture Fit **PASS** (review `5312653831`); implementation **AUTHORIZED** / **NOT_STARTED**; formal lifecycle `ARCHITECTURE_LOCKED` |
