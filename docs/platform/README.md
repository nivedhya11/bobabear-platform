...
| [`capabilities/IMP-036I-scheduled-fulfilment.md`](./capabilities/IMP-036I-scheduled-fulfilment.md) | ARCHITECTURE_FIT_CANDIDATE / NOT_LOCKED | IMP-036I Scheduled Fulfilment; Fit candidate ready for independent review; D-379 / ADR-019 **PROPOSED**; ARCH-R23 / ARCH-G29 proposed lock delta only; canonical ARCH remains ARCH-R22; Architecture Fit **NOT_PERFORMED**; implementation **NOT_AUTHORIZED** |
