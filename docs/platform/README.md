...
| [`operations/imp037-recovery-runbook.md`](./operations/imp037-recovery-runbook.md) | SUPPORTING OPERATOR | IMP-037 recovery foundation CLI/runbook (status, evidence, identity). Does not claim Layer 1/2 backup, restore, cloud mutation, or RPO/RTO proof. |
