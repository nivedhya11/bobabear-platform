...
| [`capabilities/IMP-036-observability-operational-controls.md`](./capabilities/IMP-036-observability-operational-controls.md) | CURRENT / ARCHITECTURE_LOCKED | IMP-036 Observability & Operational Controls; IMPLEMENTATION_COMPLETE_PENDING_ACCEPTANCE (`IMP-036_ACCEPTED: NO`) |
