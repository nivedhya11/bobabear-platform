...
| [`capabilities/IMP-037-backup-restore-migration-readiness.md`](./capabilities/IMP-037-backup-restore-migration-readiness.md) | CURRENT / ARCHITECTURE_LOCKED | IMP-037 Backup, Restore & Migration Readiness; architecture LOCKED; implementation NOT_AUTHORIZED / NOT_STARTED (`IMP037_ARCHITECTURE_FIT: PASS`; `IMP037_IMPLEMENTATION_AUTHORIZED: NO`) |
