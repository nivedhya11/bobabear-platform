...
| [`capabilities/IMP-036H-customer-pickup-takeaway.md`](./capabilities/IMP-036H-customer-pickup-takeaway.md) | CURRENT / COMPLETE_AND_ACCEPTED / Fit PASS | IMP-036H Customer Pickup / Takeaway; D-378 / ADR-018 CURRENT; ARCH-R22 / ARCH-G28; COMPLETE_AND_ACCEPTED (Founder UAT PASS) |
| [`capabilities/IMP-036I-scheduled-fulfilment.md`](./capabilities/IMP-036I-scheduled-fulfilment.md) | ARCHITECTURE_FIT_CANDIDATE / NOT_LOCKED | IMP-036I Scheduled Fulfilment; Fit candidate ready for independent review; D-379 / ADR-019 **PROPOSED**; D-380 / ADR-020 **PROPOSED** (human direction APPROVED 2026-09-25); ARCH-R23 / ARCH-G29 + ARCH-G30 proposed lock delta only; canonical ARCH remains ARCH-R22; Architecture Fit **NOT_PERFORMED**; implementation **NOT_AUTHORIZED** |
...
| [`operations/imp037-recovery-runbook.md`](./operations/imp037-recovery-runbook.md) | SUPPORTING OPERATOR | IMP-037 recovery operator runbook (Layer 1/2 CLI, restore, gate). Repository tooling merged; does not claim live Spaces/provider proof, systemd host install, or RPO/RTO proof. |
| [`operations/imp037-implementation-evidence.md`](./operations/imp037-implementation-evidence.md) | SUPPORTING OPS EVIDENCE | IMP-037 repository automated-proof notes + merge provenance. Not lifecycle authority. |
| [`operations/imp037-external-proof-plan.md`](./operations/imp037-external-proof-plan.md) | SUPPORTING OPS PLAN | Future R3 external-proof campaign phases + 50-AC matrix. Planning only; does not authorize live action. |
