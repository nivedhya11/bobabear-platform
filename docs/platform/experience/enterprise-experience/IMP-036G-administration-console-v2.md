...
- Responsive/accessibility/recovery behaviours are required; exact-candidate Founder UAT and
  manual keyboard + AT sampling remain **NOT_PERFORMED** (subsequent interactive gate).
