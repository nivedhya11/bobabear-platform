...
lifecycle remaining `ARCHITECTURE_LOCKED` / `AUTHORIZED` / `NOT_STARTED` (Product Definition APPROVED;
...
IMP-037 = ARCHITECTURE_LOCKED / AUTHORIZED / NOT_STARTED (IMP037_ACTIVATED: YES; Product Definition APPROVED; Gate PASS; Architecture Fit PASS; architecture LOCKED; currentProductSlice)
